...
const SFX_UPLOADER_JS = 'https://cdn.scaleflex.com/uploader/1.2.2/sfx-uploader.min.js'
const SFX_ASSET_PICKER_JS = 'https://cdn.scaleflex.com/asset-picker/1.2.2/asset-picker.min.js'
