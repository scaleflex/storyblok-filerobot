...
const SFX_UPLOADER_JS = 'https://cdn.scaleflex.com/uploader/1.4.1/sfx-uploader.min.js'
const SFX_ASSET_PICKER_JS = 'https://cdn.scaleflex.com/asset-picker/1.4.1/asset-picker.min.js'
